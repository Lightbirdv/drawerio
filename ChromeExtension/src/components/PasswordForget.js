	...
	return (
		<div className="forget-form-container">
			...
			<div className="forget-form--email">
				<input type="email" onChange={handleChange} placeholder="example@example.com" className="forget-form--email__design" size="45" />
			</div>
			{successSend && (
			...
			<button onClick={handleClick} className="forget-form--button-forget__design">
				Send Email
			</button>

			<button type="submit" onClick={() => setGoLoginPage(true)} className="forget-form--button-back__design">
				Go Back
			</button>
		</div>
	);
