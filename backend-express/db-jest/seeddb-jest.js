...
const execute = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let firstuser = yield client.query(`INSERT INTO users (email,password,isAdmin) VALUES ($1,$2,$3) ON CONFLICT DO NOTHING`, [
            "seedtestadminuser",
            yield bcrypt.hash("seedtestadminpassword", 10),
            "true",
        ]);
        console.log("Testadminuser created successfully");
        let seconduser = yield client.query(`INSERT INTO users (email,password) VALUES ($1,$2) ON CONFLICT DO NOTHING`, [
            "seedtestuser",
