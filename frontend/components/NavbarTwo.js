        ...
        <nav className="flex filter drop-shadow-md bg-white px-4 py-4 h-20 items-center">
           {/*  <MobileNav open={open} setOpen={setOpen} /> */}
            <div className="w-3/12 flex items-center">
                <a className="text-2xl font-semibold" href="/privatepage"><img src="assets/logo.jpg" className="img-logo" style={{ marginRight: "15px", maxHeight: "130px", borderRadius: "50%" }} /></a>
                <a className="text-blue-800 text-2xl hover:no-underline" href="/privatepage">Drawer.io</a>
            </div>
